...
from crest.helper.config_utils import change_config
...
if __name__ == '__main__':
    ...
    parser.add_argument("-ng", "--num_games", default=None, type=int)
    ...
    parser.add_argument("-epochs", "--epochs", default=6000, type=int)
    parser.add_argument("-anneal", "--anneal", default=3600, type=int)
    parser.add_argument("-drop", "--dropout", default=0, type=float)
    args = parser.parse_args()
    
    config = change_config(args, method='drqn')
    config['model']['lstm_dqn']['dropout_between_rnn_layers'] = args.dropout

    config['training']['scheduling']['epoch'] = args.epochs
    config['general']['epsilon_anneal_epochs'] = args.anneal

    print("##" * 30)
    print("Training for {} epochs".format(config['training']['scheduling']['epoch']))
    print("Annealing for {} epochs".format(config['general']['epsilon_anneal_epochs']))
    print("##" * 30)
